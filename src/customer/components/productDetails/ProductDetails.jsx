    ...
    <div className="bg-white">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px4 pt-10">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-wrap space-x-5 justify-center">
              {product.images.map((item,id) => (
                <div key={id} className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-w-[5rem] max-h-[5rem] mt-4">
                  <img
                    src={item.src}
                    alt={item.alt}
                    className="h-full w-full object-cover object-center"
          ...
          {/* Product info */}
          <div className="mx-auto max-w-2xl px-4 pb-16 sm:px-6  lg:max-w-7xl lg:col-span-1 lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6">
                ...
                <p className="text-green-600">{product.product?.discountedPercent}% off</p>
              </div>
